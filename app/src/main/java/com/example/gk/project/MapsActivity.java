...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraUpdate cameraPosition = CameraUpdateFactory.newLatLngZoom(eventLocation, 15);


        mMap.addMarker(new MarkerOptions().position(eventLocation).title("Marker in "+locationName));
